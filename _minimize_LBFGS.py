# -*- coding: utf-8 -*-
"""
Created on Fri Mar 27 12:09:20 2020
...
def _minimize_LBFGS(objective_function, x_initial, lr = 1, max_iter = 1000, tol = 1e-5, line_search = 'Wolfe', interpolate = True, max_ls = 100, history_size = 10, out = True):
    
    model = ModelfromFunction(objective_function, x_initial)
    
    # Define optimizer
    optimizer = FullBatchLBFGS(model.parameters(), lr = lr, history_size = history_size, line_search = line_search, debug = True)
