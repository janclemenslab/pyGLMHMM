...
An example plot of :class:`skl_glm_hmm._glm_hmm.GLMHMMEstimator`
"""
...
estimator = GLMHMMEstimator(num_samples = num_samples, num_states = num_states, num_emissions = num_emissions, num_feedbacks = num_feedbacks, num_filter_bins = num_filter_bins, num_steps = num_steps)
estimator.fit(output_stim, output_trace, np.array([]))
